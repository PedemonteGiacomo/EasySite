<!-- Simple carousel to display 4 images full-screen -->

<template>
  <div>
    <q-carousel swipeable animated v-model="slide" :autoplay="autoplay" ref="carousel" infinite>
      <q-carousel-slide :name="1" img-src="/images/carousel/genova.jpg" style="
          ...
          bottom: 0;
        " />
      <q-carousel-slide :name="2" img-src="/images/office/material.jpg" style="
          object-fit: scale-down;
          width: 100%;
          height: 50%;
          position: relative;
          bottom: 0;
        " />
      <q-carousel-slide :name="3" img-src="/images/services/sanficazione.jpg" style="
          object-fit: scale-down;
          width: 100%;
          height: 50%;
          position: relative;
          bottom: 0;
        " />
      <q-carousel-slide :name="4" img-src="/images/services/condominio.jpeg" style="
          object-fit: scale-down;
          width: 100%;
          height: 50%;
          position: relative;
